...
class RegistrationAgent{
  // CR-4: ensureColumn()/ensureSchema() lived here and ran two CREATE TABLE
  // statements plus seventeen INFORMATION_SCHEMA column probes on EVERY
  // registration, login, verification and approval request. Both tables —
  // customer_account_registrations and auth_event_logs — plus that exact
  // additive-column list are now owned by config/bootstrap.js ensureSchema(),
  // which runs once at startup. No business method creates or alters a table.
