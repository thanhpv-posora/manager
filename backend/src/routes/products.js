...
router.put('/customer-prices/:customerId/:productId', auth(['ADMIN','STAFF','CUSTOMER']), async (req,res,next)=>{try{res.json(await ProductAgent.updateCustomerPrice(req.params.customerId,req.params.productId,req.body.sale_price))}catch(e){next(e)}});
