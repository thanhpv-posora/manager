...
export default function Revenue(){
 ...
 const totals=useMemo(()=>rows.reduce((s,r)=>({
  revenue:s.revenue+Number(r.revenue||0),paid:s.paid+Number(r.paid||0),debt:s.debt+Number(r.debt||0),orders:s.orders+Number(r.orders||0)
 }),{revenue:0,paid:0,debt:0,orders:0}),[rows]);
 const printRevenue=()=>{
