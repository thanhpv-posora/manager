...
router.post('/registrations/:id/approve',auth(['ADMIN']),async(req,res,next)=>{try{res.json(await UserCustomerMappingAgent.approveRegistration(req.params.id))}catch(e){next(e)}});
