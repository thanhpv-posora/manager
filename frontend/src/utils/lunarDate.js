...
// one 30-day block above, which it corrects) before shipping.
...
// getNewMoonDay (which follows this file's older, JD-2415021-based epoch);
// getNewMoonDay bridges the two via meanNewMoonSeed + a decimal-year guess,
// see below.
...
export function parseLunarText(text){
...
export function lunarToSolarDate(lunar){
